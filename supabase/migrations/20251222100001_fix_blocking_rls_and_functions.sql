...
DROP POLICY IF EXISTS "Users can insert blocked identities for their tenant" ON public.blocked_identities;
DROP POLICY IF EXISTS "Users can update their tenant blocked identities" ON public.blocked_identities;
DROP POLICY IF EXISTS "Users can delete their tenant blocked identities" ON public.blocked_identities;
